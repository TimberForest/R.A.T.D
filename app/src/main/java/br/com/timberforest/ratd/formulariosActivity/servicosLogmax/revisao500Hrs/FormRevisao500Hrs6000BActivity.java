...
public class FormRevisao500Hrs6000BActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_form_revisao500_hrs6000_b);
    ...
    public void selecionarOpcao(View view) {
        switch (view.getId()) {
            case R.id.linearLayout324:
                startActivity(new Intent(this, DesenhoBlocoHidraulicoCabecoteLogMax6000Activity.class));
                break;
