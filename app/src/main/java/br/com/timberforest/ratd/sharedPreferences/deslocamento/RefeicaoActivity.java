...
public class RefeicaoActivity extends AppCompatActivity {
    ...
    private void atualizaCampos() {
        ...
        Log.i("info", "tempo 1: "+txt_tempo_ref1.getText().toString());
        Log.i("info", "tempo 2: "+txt_tempo_ref2.getText().toString());
        Log.i("info", "tempo 3: "+txt_tempo_ref3.getText().toString());
        Log.i("info", "tempo 4: "+txt_tempo_ref4.getText().toString());
        Log.i("info", "tempo 5: "+txt_tempo_ref5.getText().toString());
        Log.i("info", "tempo 6: "+txt_tempo_ref6.getText().toString());
...
//            minutosDiferenca = String.valueOf(diffMinutes);
    ...
    private void totalDeslocamento(TextView tempo1, TextView tempo2, TextView tempo3, TextView tempo4, TextView tempo5, TextView tempo6) {
        try {
            ...
            Log.i("info", "*---*---*---*---*---*---*---*---*");
            Log.i("info", "Total Refeição: "+resultado);
